...
const AchievementsPage = () => {
  ...
  const categories: AchievementCategory[] = ['First Steps', 'Speed Running', 'Currency Milestones', 'Prestige Master', 'Workshop Mastery', 'Overclock Engineer', 'Research & Development', 'Golem Mastery', 'Challenge Conqueror', 'Cosmic Achievements', 'Efficiency Master', 'Ancient Wisdom', 'Hidden & Fun'];
