...
export const useGameSession = (props: UseGameSessionProps) => {
    ...
    const resetState = useCallback(() => {
        ...
        setLastSaveTime, setSaveStatus, setBuyQuantity, setOverclockLevel, setAchievements, setUnlockedResearchNodes, setActiveGolemIds, setHasBeatenGame, setGameCompletionShown
    ]);
